...
[CustomEditor(typeof(GetTileMapData))]
public class GetTileMapDataEditor : Editor
{
    string nombre = "";

    public override void OnInspectorGUI ()
    {
        GetTileMapData GTM = (GetTileMapData)target;
    ...
    public class GetTileMapData : MonoBehaviour
{
